...
public class PartOne {
    ...
    public static void main(String[] args) throws Exception {
        ...
        bfs(startX, startY);
        int totalTrueVisited = visited.values().stream().filter(value -> value)
                .toArray().length;
        System.out.println(totalTrueVisited / 2);
    }
     ...
     */
    private static void ifNotVisitedAddToQueue(PartOne.Coordinates next) {
        if (!visited.get(next)) {
