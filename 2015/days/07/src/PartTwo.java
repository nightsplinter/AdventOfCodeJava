...
/**
 * --- Day 7: Some Assembly Required --- --- Part Two ---
 *
...
public class PartTwo {
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<String> inputWithoutB = new ArrayList<String>();

        Pattern bPattern = Pattern.compile(".*\\-\\>\\sb");
        ...
        do {
            ...
            if (input.size() == 0 && inputWithoutB.size() != 0) {
                String a = wires.get("a");
                input.addAll(inputWithoutB);
                inputWithoutB.removeAll(inputWithoutB);
                wires.clear();
                wires.put("b", a);
                i = 0;
            }
